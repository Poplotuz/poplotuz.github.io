...
!function(c){c.fn.simpleJekyllSearch=function(e){console.log("simpleJekyllSearch");var o=c.extend({jsonFile:"/search.json",jsonFormat:"title,tags,categories,url,date",template:'<li><article><a href="{url}">{title} </a></article></li>',searchResults:".search-results",limit:"10",noResults:"<p>Oh no! We didn't find anything :(</p>"},e),s=o.jsonFormat.split(","),a=[],t=this,i=c(o.searchResults);function r(){i.children().remove()}o.jsonFile.length&&i.length&&c.ajax({type:"GET",url:o.jsonFile,dataType:"json",success:function(e,l,n){a=e,t.keyup(function(e){var l,n,t;c(this).val().length?(n=c(this).val(),t=[],console.log("perfom search"),c.each(a,function(e,l){for(e=0;e<s.length;e++)void 0!==l[s[e]]&&-1!==l[s[e]].toLowerCase().indexOf(n.toLowerCase())&&(t.push(l),e=s.length)}),l=t,r(),i.append(c(o.searchResultsTitle)),l.length?c.each(l,function(e,l){if(e<o.limit){for(var n=o.template,e=0;e<s.length;e++)var t=new RegExp("{"+s[e]+"}","g"),n=n.replace(t,l[s[e]]);i.append(c(n))}}):i.append(o.noResults)):r()})},error:function(e,l,n){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(l),console.log(n)}})}}(Zepto);
...
!function(e,o){e("#menu").click(function(){e("body").addClass("push-menu-to-right"),e("#sidebar").addClass("open"),e(".overlay").addClass("show")}),e("#mask").click(function(){e("body").removeClass("push-menu-to-right"),e("#sidebar").removeClass("open"),e(".overlay").removeClass("show")}),e(o).scroll(function(){0<e(this).scrollTop()?e("body").addClass("light"):e("body").removeClass("light")});var s=e(".modal .close"),n=(s.on("click",function(){s.parent().parent().addClass("closed")}),e(".modal.exit")),o=(n.length&&ouibounce(n[0],{aggressive:!0,callback:function(){n.find(".close").on("click",function(){n.hide()})}}),{close:e(".icon-remove-sign"),searchform:e(".search-form"),canvas:e("body"),dothis:e(".dosearch")});e(".search-field").on("input",function(){e(".search-field").simpleJekyllSearch()}),o.close.on("click",function(){e(".search-field").val("")}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);
