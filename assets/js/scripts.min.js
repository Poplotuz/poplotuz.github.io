...
!function(c){c.fn.simpleJekyllSearch=function(e){console.log("simpleJekyllSearch");var s=c.extend({jsonFile:"/search.json",jsonFormat:"title,tags,categories,url,date",template:'<li><article><a href="{url}">{title} <span class="entry-date"><time datetime="{date}">{date}</time></span></a></article></li>',searchResults:".search-results",limit:"10",noResults:"<p>Oh no! We didn't find anything :(</p>"},e),o=s.jsonFormat.split(","),a=[],n=this,i=c(s.searchResults);function r(){i.children().remove()}s.jsonFile.length&&i.length&&c.ajax({type:"GET",url:s.jsonFile,dataType:"json",success:function(e,t,l){a=e,n.keyup(function(e){var t,l,n;c(this).val().length?(l=c(this).val(),n=[],console.log("perfom search"),c.each(a,function(e,t){for(e=0;e<o.length;e++)void 0!==t[o[e]]&&-1!==t[o[e]].toLowerCase().indexOf(l.toLowerCase())&&(n.push(t),e=o.length)}),t=n,r(),i.append(c(s.searchResultsTitle)),t.length?c.each(t,function(e,t){if(e<s.limit){for(var l=s.template,e=0;e<o.length;e++)var n=new RegExp("{"+o[e]+"}","g"),l=l.replace(n,t[o[e]]);i.append(c(l))}}):i.append(s.noResults)):r()})},error:function(e,t,l){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(t),console.log(l)}})}}(Zepto);
