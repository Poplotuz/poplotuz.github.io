...
!function(o,e){o("#menu").click(function(){o("body").addClass("push-menu-to-right"),o("#sidebar").addClass("open"),o(".overlay").addClass("show")}),o("#mask").click(function(){o("body").removeClass("push-menu-to-right"),o("#sidebar").removeClass("open"),o(".overlay").removeClass("show")}),o(e).scroll(function(){0<o(this).scrollTop()?o("body").addClass("light"):o("body").removeClass("light")});var s=o(".modal .close"),a=(s.on("click",function(){s.parent().parent().addClass("closed")}),o(".modal.exit")),n=(a.length&&ouibounce(a[0],{aggressive:!0,callback:function(){a.find(".close").on("click",function(){a.hide()})}}),{close:o(".icon-remove-sign"),searchform:o(".search-form"),canvas:o("body"),dothis:o(".dosearch")});function l(){o(".search-wrapper").toggleClass("active"),n.searchform.toggleClass("active"),n.canvas.removeClass("search-overlay")}o(".search-field").on("input",function(){o(".search-field").simpleJekyllSearch()}),n.close.on("click",l),document.addEventListener("keyup",function(e){27==e.keyCode&&o(".search-overlay").length&&l()}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);
