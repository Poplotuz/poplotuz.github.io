...
!function(r){r.fn.simpleJekyllSearch=function(e){r(".icon-remove-sign").on("click",function(){c(),r(".search-field").val("")});var o=r.extend({jsonFile:"/search.json",jsonFormat:"title,tags,categories,url,date",template:'<li><article><a href="{url}">{title} </a></article></li>',searchResults:".search-results",limit:"10",noResults:"<p>Oh no! We didn't find anything :(</p>"},e),s=o.jsonFormat.split(","),i=[],t=this,a=r(o.searchResults);function c(){a.children().remove()}o.jsonFile.length&&a.length&&r.ajax({type:"GET",url:o.jsonFile,dataType:"json",success:function(e,n,l){i=e,t.keyup(function(e){var n,l,t;r(this).val().length?(l=r(this).val(),t=[],console.log("perfom search"),r.each(i,function(e,n){for(e=0;e<s.length;e++)void 0!==n[s[e]]&&-1!==n[s[e]].toLowerCase().indexOf(l.toLowerCase())&&(t.push(n),e=s.length)}),n=t,c(),a.append(r(o.searchResultsTitle)),n.length?r.each(n,function(e,n){if(e<o.limit){for(var l=o.template,e=0;e<s.length;e++)var t=new RegExp("{"+s[e]+"}","g"),l=l.replace(t,n[s[e]]);a.append(r(l))}}):a.append(o.noResults)):c()})},error:function(e,n,l){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(n),console.log(l)}})}}(Zepto);
...
!function(e,o){e("#menu").click(function(){e("body").addClass("push-menu-to-right"),e("#sidebar").addClass("open"),e(".overlay").addClass("show")}),e("#mask").click(function(){e("body").removeClass("push-menu-to-right"),e("#sidebar").removeClass("open"),e(".overlay").removeClass("show")}),e(o).scroll(function(){0<e(this).scrollTop()?e("body").addClass("light"):e("body").removeClass("light")});var n=e(".modal .close"),s=(n.on("click",function(){n.parent().parent().addClass("closed")}),e(".modal.exit"));s.length&&ouibounce(s[0],{aggressive:!0,callback:function(){s.find(".close").on("click",function(){s.hide()})}}),e(".icon-remove-sign"),e(".search-form"),e("body"),e(".dosearch");e(".search-field").on("input",function(){e(".search-field").simpleJekyllSearch()}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);
